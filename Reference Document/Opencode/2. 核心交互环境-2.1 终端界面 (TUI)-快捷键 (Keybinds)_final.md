...
title: Keybinds
slug: keybinds
description: Customize your keybinds - OpenCode has a list of keybinds that you can customize through the OpenCode config.
---
...
<Callout type="note">
Shift+Enter: Some terminals don't send modifier keys with Enter by default. You may need to configure your terminal to send Shift+Enter as an escape sequence.
</Callout>
