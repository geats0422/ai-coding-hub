---
title: "Quick start and installation"
description: "Learn how to quickly install, configure, and start using Gemini CLI, including standard installation, Docker sandboxing, and running from source."
tool: "gemini-cli"
...
For more installation options, see [Gemini CLI Installation](/docs/gemini/quickstart-installation).
...
To explore the power of Gemini CLI, see [Gemini CLI examples](/docs/gemini/quickstart-installation).

## What's next?

- Find out more about [Gemini CLI's tools](/docs/gemini/file-system-tools).
- Review [Gemini CLI's commands](/docs/gemini/custom-commands).
- Learn how to [get started with Gemini 3](/docs/gemini/model-selection).
