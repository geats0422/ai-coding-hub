---
title: "CLI settings and preferences"
description: "Learn how to use the /settings command and the settings.json file to customize various configurations of Gemini CLI, including interface themes, shortcut keys, accessibility functions, etc."
tool: "gemini-cli"
