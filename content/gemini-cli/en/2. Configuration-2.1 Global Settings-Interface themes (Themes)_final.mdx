---
title: "Interface themes (Themes)"
description: "Explore the various themes supported by the Gemini CLI, including dark themes, light themes, and how to create custom themes."
tool: "gemini-cli"
slug: "ui-themes"
locale: "en"
---
...
[configuration](/docs/gemini/cli-settings-preferences) so your preference is
...
- Custom themes can be set at the user, project, or system level, and follow the
  same [configuration precedence](/docs/gemini/cli-settings-preferences) as other
  settings.
