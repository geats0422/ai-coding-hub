...
description: "Learn how to select a Gemini model using the /model command, including the pros, cons, and best practices of Auto, Pro, and Flash models."
tool: "gemini-cli"
...
[**Preview Features** by using the `settings` command](/docs/gemini/cli-settings-preferences).
