...
description: "Learn about the complete set of file system tools provided by the Gemini CLI, including how to use tools such as list_directory, read_file, write_file, glob, grep_search, and replace."
tool: "gemini-cli"
