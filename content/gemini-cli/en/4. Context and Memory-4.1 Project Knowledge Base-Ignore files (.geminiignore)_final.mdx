---
title: "Ignore files (.geminiignore)"
description: "Learn how to use .geminiignore files to exclude unnecessary files and directories and optimize Gemini CLI's contextual searches."
tool: "gemini-cli"
