...
description: "Learn more about using the GEMINI.md file to provide context for your project, including context hierarchies, modular imports, and custom configuration methods."
tool: "gemini-cli"
...
For more details, see the [Memory Import Processor](/docs/gemini/memory-tool)
documentation.
