...
description: "Learn how to create and use custom commands in the Gemini CLI, save and reuse frequently used prompt words via TOML files."
tool: "gemini-cli"
...
2.  **Argument substitution:** If `{{args}}` is present inside the block, it
    is automatically shell-escaped (see
