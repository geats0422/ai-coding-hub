---
title: "Headless Mode"
description: "Learn how to use Gemini CLI's headless mode with command-line scripts and automation tools, including direct prompts, Stdin input, JSON output format, and more."
tool: "gemini-cli"
slug: "headless-mode"
locale: "en"
---
...
- [CLI Configuration](/docs/gemini/cli-settings-preferences) - Complete configuration
  guide
- [Authentication](/docs/gemini/quickstart-installation) - Setup authentication
- [Commands](/docs/gemini/custom-commands) - Interactive commands reference
- [Tutorials](/docs/gemini/quickstart-installation) - Step-by-step automation guides
