---
title: "Hook scripts (Hooks)"
description: "Understand Gemini CLI's hook system and learn how to inject custom logic and validation at specific points in the agent loop."
tool: "gemini-cli"
slug: "hooks"
locale: "en"
---
...
- **[Writing hooks guide](/docs/gemini/hooks)**: A tutorial on creating
  your first hook with comprehensive examples.
- **[Best practices](/docs/gemini/hooks)**: Guidelines on security,
  performance, and debugging.
- **[Hooks reference](/docs/gemini/hooks)**: The definitive technical
...
See [Security Considerations](/docs/gemini/hooks)
