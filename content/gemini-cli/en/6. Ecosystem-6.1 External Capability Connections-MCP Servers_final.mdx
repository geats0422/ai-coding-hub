---
title: "MCP Servers"
description: "Dive into the configuration and use of the Model Context Protocol (MCP) server, and learn how to integrate external tools and data sources in the Gemini CLI."
tool: "gemini-cli"
slug: "mcp-servers"
locale: "en"
---
...
1. **[Create](https://cloud.google.com/iap/docs/oauth-client-creation) or use an existing OAuth 2.0 client ID.**
2. **Add the OAuth ID to the allowlist for programmatic access.**
3. **Create a service account.**
4. **Add both the service account and users to the IAP Policy.**
5. **Grant permissions to impersonate the service account.**
6. **[Enable](https://console.cloud.google.com/apis/library/iamcredentials.googleapis.com) the IAM Credentials API.**
...
Gemini CLI's capabilities while maintaining security, reliability, and ease of use.
