---
title: "Agent Skills"
description: "Understand Gemini CLI’s Agent Skills feature and learn how to create and use specialized agent skills to extend CLI capabilities."
tool: "gemini-cli"
slug: "agent-skills"
locale: "en"
---
...
Unlike general context files ([`GEMINI.md`](/docs/gemini/project-context-gemini-md)), which provide
...
3.  **Extension Skills**: Skills bundled within installed
    [extensions](/docs/gemini/extensions-management).
...
To create your own skills, see the [Create Agent Skills](/docs/gemini/agent-skills)
guide.
