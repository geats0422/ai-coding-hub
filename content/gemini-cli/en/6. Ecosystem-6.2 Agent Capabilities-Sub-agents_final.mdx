---
title: "Sub-agents"
description: "Explore Gemini CLI's subagent capabilities and learn how to create and use specialized agents to handle complex tasks."
tool: "gemini-cli"
slug: "sub-agents"
locale: "en"
---
...
["YOLO mode"](/docs/gemini/cli-settings-preferences), meaning
...
See the [Remote Subagents documentation](/docs/gemini/sub-agents) for detailed
configuration and usage instructions.

## Extension sub-agents

Extensions can bundle and distribute sub-agents. See the
[Extensions documentation](/docs/gemini/sub-agents) for details on how
