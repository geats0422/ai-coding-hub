...
description: "Learn how to integrate the Gemini CLI in supported IDEs, including workspace context, local diffs, and VS Code commands."
tool: "gemini-cli"
...
[IDE Companion Extension Spec](/docs/gemini/ide-integration).
