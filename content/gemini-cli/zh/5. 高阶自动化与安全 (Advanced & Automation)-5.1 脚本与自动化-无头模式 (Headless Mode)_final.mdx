...
- [CLI Configuration](/docs/gemini/cli-settings-preferences) - 完整配置
  指南
- [Authentication](/docs/gemini/quickstart-installation) - 设置身份验证
- [Commands](/docs/gemini/custom-commands) - 交互式命令参考
- [Tutorials](/docs/gemini/quickstart-installation) - 分步自动化指南
