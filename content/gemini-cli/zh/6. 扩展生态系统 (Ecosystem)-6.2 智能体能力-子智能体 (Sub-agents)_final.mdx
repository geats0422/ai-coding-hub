...
```
警告：分代理目前在以下地区运营
["YOLO mode"](/docs/gemini/cli-settings-preferences)，意思是
...
详细见[Remote Subagents documentation](/docs/gemini/sub-agents)
配置和使用说明。

## 扩展子代理

扩展可以捆绑和分发子代理。请参阅
[Extensions documentation](/docs/gemini/sub-agents) 了解如何操作的详细信息
