...
tool: "opencode"
slug: agent-skills
description: Define reusable behavior via SKILL.md definitions - agent skills let OpenCode discover reusable instructions from your repo or home directory.
---
