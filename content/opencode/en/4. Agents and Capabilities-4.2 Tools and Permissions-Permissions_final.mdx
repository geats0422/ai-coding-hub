...
tool: "opencode"
slug: permissions
description: Control which actions require approval to run - OpenCode uses the permission config to decide whether a given action should run automatically, prompt you, or be blocked.
---
