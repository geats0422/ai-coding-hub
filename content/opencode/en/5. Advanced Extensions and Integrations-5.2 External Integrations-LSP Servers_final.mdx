...
tool: "opencode"
slug: lsp-servers
description: OpenCode integrates with your LSP servers - OpenCode integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase.
---
