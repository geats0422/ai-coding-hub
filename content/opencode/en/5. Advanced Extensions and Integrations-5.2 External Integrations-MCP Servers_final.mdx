...
tool: "opencode"
slug: mcp-servers
description: Add local and remote MCP tools - you can add external tools to OpenCode using the Model Context Protocol, or MCP.
---
...
| clientId | String | false | OAuth client ID. If not provided, dynamic client registration will be attempted. |
| clientSecret | String | false | OAuth client secret, if required by the authorization server. |
| scope | String | false | OAuth scopes to request during authorization. |
